...
//	return query;
//};
//var Query = Object.extend(function(){},{
//	__clone: Query,
//	test: function(object) {
//		for (var x in this.whereTest) {
//			if (x in object) {
//				var candidate = object[x];
//				var test = this.whereTest[x];
...
//
//
//var ArrayQuery = Query.extend(function ArrayQuery() {},{
//	__clone: ArrayQuery,
//	get: function() {
//		var results;
//		if (this.whereTest) {
